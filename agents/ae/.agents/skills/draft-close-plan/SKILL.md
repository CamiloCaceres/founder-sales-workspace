...
description: Use when the user says "build a mutual action plan with {Acme}" / "close plan for {Acme}" — stitches call analyses into a shared timeline with procurement / security / budget / owners / dates and surfaces what's still UNKNOWN.
---
