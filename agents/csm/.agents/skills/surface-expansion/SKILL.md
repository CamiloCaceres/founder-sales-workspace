...
description: Use when the user says "any expansion opportunities in my book" / "who's ripe for upsell" — scans GREEN customers for usage spikes / team growth / feature-request patterns and ranks opportunities by ARR impact vs effort.
---
...
5. **For high-signal candidates, write a per-customer brief:**
   ...
   effort-to-close, and the one-line pitch the AE would use.
