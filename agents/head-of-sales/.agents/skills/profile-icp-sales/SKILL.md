---
name: profile-icp-sales
description: Use when the user says "profile the buying committee for {segment}" / "who signs at {segment}" / "build a persona for sales" — produces a sales-flavored persona covering champion, economic buyer, blocker, disqualifiers, and triggers.
---
...
decision" — the 4 things the SDR and AE need to tune outreach and
discovery.
