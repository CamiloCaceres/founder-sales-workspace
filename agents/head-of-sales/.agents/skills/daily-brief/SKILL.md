---
name: daily-brief
description: Use when the user says "brief me for today" / "what's on today" / "morning brief" — produces today's calendar + approvals queue + top-3 moves in one screen.
---
...
1. **Read the playbook.** Load `sales-playbook.md`. If missing, warn
